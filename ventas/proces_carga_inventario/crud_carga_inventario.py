...
def listar_productos_cargados_y_sin_cargar_autocomplete(request):
    ...
    for producto in producto:
        fila=str(producto.id)+'|'+str(producto.nombre_producto)+'|'+'ninguna'+'|'+'0'
        list_prod.append(fila)
    
    for producto_stock in producto_stock:
        fila=str(producto_stock.id)+'|'+str(producto_stock.producto.nombre_producto)+'|'+str(producto_stock.presentacion)+'|'+str(producto_stock.cantidad)
        list_prod.append(fila)   
